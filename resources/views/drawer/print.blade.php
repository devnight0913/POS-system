...
<body>
    ...
    <div style="display: flex;margin-bottom: 1.5rem">
        ...
        <div style="margin-left: auto">{{ currency_format($drawerHistory->starting_cash) }}</div>
    </div>
    <div style="display: flex;margin-bottom: 1.5rem">
        <div>@lang('Cash Sales')</div>
        <div style="margin-left: auto">{{ currency_format($drawerHistory->cash_sales) }}</div>
    </div>
    <div style="display: flex;margin-bottom: 1.5rem">
        <div>@lang('Payouts')</div>
        <div style="margin-left: auto">{{ currency_format($drawerHistory->paid_out) }}</div>
    </div>
    <div style="display: flex;margin-bottom: 1.5rem;font-weight: 700">
        <div>@lang('Expected in drawer')</div>
        <div style="margin-left: auto">{{ currency_format($drawerHistory->expected) }}</div>
    </div>
    <div style="display: flex;margin-bottom: 1.5rem">
        <div>@lang('Actual in drawer')</div>
        <div style="margin-left: auto">{{ currency_format($drawerHistory->actual) }}</div>
    </div>
    <div style="display: flex;margin-bottom: 1.5rem">
        <div>@lang('Difference')</div>
        <div style="margin-left: auto">{{ $drawerHistory->difference_view }}</div>
    </div>
    <hr style="font-weight: 700;margin-bottom: 1.5rem">
</body>
