...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            <a href="{{ route('customers.orders.index', $customer) }}"
                class="shadow-sm rounded-3 p-3 justify-content-between position-relative d-flex text-decoration-none bg-white">
                <div>
                    ...
                    <span class="d-block mt-1 small text-black">
                        @lang('Invoices')
                    </span>
                </div>
                <div class="d-flex align-items-center">
                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="text-primary-500 w-10 h-10 xl:w-12 xl:h-12">
            ...
            <a href="#"
                ...
                <div class="d-flex align-items-center">
                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <circle cx="25" cy="25" r="25" fill="#FDE4E5"></circle>
                        <path
    ...
    <div class="card shadow-sm rounded-3 mb-3">
        <div class="card-body">
            <div class="card-title h5">@lang('Profile')</div>
            <table class="table table-bordered mb-0">
                ...
                <tr>
                    <td>@lang('Birthday')</td>
                    <td class="fw-bold">{{ $customer->birthday }}</td>
                </tr>
                <tr>
                    <td>@lang('Gender')</td>
                    <td class="fw-bold">{{ $customer->gender }}</td>
                </tr>
                <tr>
                    <td>@lang('Civil Status')</td>
                    <td class="fw-bold">{{ $customer->civil_status }}</td>
                </tr>
                <tr>
                    <td>@lang('Nationality')</td>
                    <td class="fw-bold">{{ $customer->nationality }}</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="card shadow-sm rounded-3 mb-3">
        <div class="card-body">
            <div class="card-title h5">@lang('Contact Info')</div>
            <table class="table table-bordered mb-0">
                <tr>
                    <td>@lang('Mobile Number')</td>
                    <td class="fw-bold">
                        {{ $customer->mobile }}
                    </td>
                </tr>
                <tr>
                    <td>@lang('Telephone Number')</td>
                    <td class="fw-bold">
                        {{ $customer->telephone }}
                    </td>
                </tr>
                <tr>
                    <td>@lang('Fax')</td>
                    <td class="fw-bold">{{ $customer->fax }}</td>
                </tr>
                <tr>
                    <td>@lang('Email')</td>
    ...
    <div class="card shadow-sm rounded-3 mb-3">
        <div class="card-body">
            <div class="card-title h5">@lang('Address')</div>
            <table class="table table-bordered mb-0">
                <tr>
                    <td>@lang('City')</td>
                    <td class="fw-bold">{{ $customer->city }}</td>
                </tr>
                <tr>
                    <td>@lang('Street')</td>
                    <td class="fw-bold">{{ $customer->street_address }}</td>
                </tr>
                <tr>
                    <td>@lang('Building')</td>
                    <td class="fw-bold">{{ $customer->building }}</td>
                </tr>
                <tr>
                    <td>@lang('Floor')</td>
                    <td class="fw-bold">{{ $customer->floor }}</td>
                </tr>
                <tr>
                    <td>@lang('Apartment')</td>
                    <td class="fw-bold">{{ $customer->apartment }}</td>
                </tr>
                <tr>
                    <td>@lang('State')</td>
                    <td class="fw-bold">{{ $customer->state }}</td>
                </tr>
                <tr>
                    <td>@lang('Country')</td>
                    <td class="fw-bold">{{ $customer->country }}</td>
                </tr>
                <tr>
                    <td>@lang('Zip Code')</td>
                    <td class="fw-bold">{{ $customer->zip_code }}</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="card shadow-sm rounded-3 mb-3">
        <div class="card-body">
            <div class="card-title h5">@lang('Company Info')</div>
            <table class="table table-bordered mb-0">
                <tr>
                    <td>@lang('Company') @lang('Name')</td>
                    <td class="fw-bold">{{ $customer->company_name }}</td>
                </tr>
                <tr>
                    <td>@lang('Company') @lang('Address')</td>
                    <td class="fw-bold">{{ $customer->company_street_address }}</td>
                </tr>
                <tr>
                    <td>@lang('Company') @lang('City')</td>
                    <td class="fw-bold">{{ $customer->company_city }}</td>
                </tr>
                <tr>
                    <td>@lang('Company') @lang('State')</td>
                    <td class="fw-bold">{{ $customer->company_state }}</td>
                </tr>
                <tr>
                    <td>@lang('Company') @lang('Country')</td>
                    <td class="fw-bold">{{ $customer->company_country }}</td>
                </tr>
                <tr>
                    <td>@lang('Company') @lang('Zip Code')</td>
                    <td class="fw-bold">{{ $customer->company_zip_code }}</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="card shadow-sm rounded-3 mb-3">
        <div class="card-body">
            <div class="card-title h5">@lang('Other Info')</div>
            <table class="table table-bordered mb-0">
                <tr>
                    <td>@lang('Tax ID Number')</td>
                    <td class="fw-bold">{{ $customer->tax_identification_number }}</td>
                </tr>
                <tr>
                    <td>@lang('Notes')</td>
                    <td class="fw-bold">{{ $customer->notes }}</td>
                </tr>
